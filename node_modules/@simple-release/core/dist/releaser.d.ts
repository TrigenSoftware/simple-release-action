...
import type { PickOverridableOptions, ReleaserCheckoutOptions, ReleaserOptions, ReleaserCommitOptions, ReleaserMaintenanceBranchOptions, ReleaserSetUserOptions, ReleaserTagOptions, ReleaserPushOptions, ReleaserStepsOptions } from './releaser.types.js';
...
export declare class Releaser<P extends Project = Project, G extends GitRepositoryHosting = GitRepositoryHosting> {
     ...
     * @returns Project releaser instance for chaining.
     */
    maintenanceBranch(options?: ReleaserMaintenanceBranchOptions): this;
    /**
