import type { CommitKnownProps, CommitGroup, CommitNote, NoteGroup, FinalTemplateContext, HeaderPartialFunction, PreamblePartialFunction, CommitPartialFunction, FooterPartialFunction } from '@conventional-changelog/template';
...
export type CommitTransformFunction<Commit extends CommitKnownProps = CommitKnownProps> = (commit: Commit, context: FinalTemplateContext<Commit>, options: FinalOptions<Commit>) => Partial<Commit> | null | Promise<Partial<Commit> | null>;
export type GenerateOnFunction<Commit extends CommitKnownProps = CommitKnownProps> = (keyCommit: Commit, commitsGroup: Commit[], context: FinalTemplateContext<Commit>, options: FinalOptions<Commit>) => boolean;
export type TemplateFunction<Commit extends CommitKnownProps = CommitKnownProps> = (context: FinalTemplateContext<Commit>) => string | Promise<string>;
export interface Options<Commit extends CommitKnownProps = CommitKnownProps> {
     ...
     * @param commits
     */
    finalizeContext?(context: FinalTemplateContext<Commit>, options: FinalOptions<Commit>, filteredCommits: Commit[], keyCommit: Commit | null, commits: Commit[]): FinalTemplateContext<Commit> | Promise<FinalTemplateContext<Commit>>;
    /**
