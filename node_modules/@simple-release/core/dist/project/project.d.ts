...
import type { ProjectOptions, ProjectBumpOptions, ProjectVersionUpdate, ProjectTagsOptions, ProjectReleaseOptions, ProjectMaintenanceBranch, ProjectPublishOptions, ProjectRevertOptions } from './project.types.js';
...
export declare abstract class Project {
     ...
     */
    getMaintenanceBranches(options?: ProjectReleaseOptions): Promise<ProjectMaintenanceBranch[]>;
    /**
