...
export declare const WHAT_BUMP_ERROR_MESSAGE = "`whatBump` must be a function";
/**
...
export declare class Bumper {
     ...
     */
    bump(whatBump?: ((commits: Commit[]) => Promise<import("./types.js").WhatBumpResult> | import("./types.js").WhatBumpResult) | null): Promise<BumperRecommendationResult>;
}
