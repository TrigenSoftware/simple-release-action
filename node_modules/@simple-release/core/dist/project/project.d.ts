...
import type { ProjectOptions, ProjectBumpOptions, ProjectVersionUpdate, ProjectTagsOptions, ProjectReleaseOptions, ProjectMaintenanceBranchesOptions, ProjectMaintenanceBranch, ProjectPublishOptions, ProjectRevertOptions } from './project.types.js';
...
export declare abstract class Project {
     ...
     */
    getHostedGitInfo(): Promise<import("conventional-changelog").HostedGitInfo | null>;
    /**
     ...
     */
    getLastReleaseTag(options?: ProjectReleaseOptions): Promise<string | null>;
    /**
     ...
     */
    isLatestRelease(options?: ProjectReleaseOptions): Promise<boolean>;
    /**
     ...
     */
    getDefaultPublishTag(options?: ProjectReleaseOptions): Promise<string | undefined>;
    /**
     ...
     */
    getMaintenanceBranches(options?: ProjectMaintenanceBranchesOptions): Promise<ProjectMaintenanceBranch[]>;
    /**
     ...
     */
    revert(options?: ProjectRevertOptions, filesSet?: Set<string>): Promise<boolean>;
    /**
     * Publish the project.
     * @param options
     */
