...
import { type MonorepoProjectOptions, type MonorepoMode, type GetProjectsOptions, MonorepoProject } from './monorepo.js';
 ...
 */
export declare class PackageJsonMonorepoProject extends MonorepoProject {
    /**
     * Creates a package.json based monorepo project.
     * @param options
     */
    constructor(options: PackageJsonMonorepoProjectOptions);
    publish(_options?: ProjectPublishOptions): Promise<void>;
}
//# sourceMappingURL=packageJsonMonorepo.d.ts.map