...
import { type ProjectOptions, type ProjectTagsOptions, type ProjectReleaseOptions, type ProjectMaintenanceBranch, type ProjectMaintenanceBranchesOptions, type ProjectRevertOptions, Project } from './project.js';
...
export declare abstract class MonorepoProject extends Project {
     ...
     */
    getProjects(): AsyncGenerator<Project, void, unknown>;
    /**
    ...
    private getIndependentDefaultPublishTag;
    /**
    ...
    private getIndependentMaintenanceBranches;
    ...
    revert(options?: ProjectRevertOptions): Promise<boolean>;
}
